...
def generate_pptx(
    ...
    Slides:
        ...
        N-1 Analysis & Recommendation Rationale  (if analysis provided)
        N   Closing / call-to-action
    """
    # ── Apply theme: override C dict so all _build_* functions use theme colors ──
    from themes import get_theme_colors
    C.update(get_theme_colors(theme))
